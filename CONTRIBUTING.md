...
Before you submit your issue, please search the issue list of the project - maybe your question or issue has already been identified or addressed.

If you find a bug in the source code, you can help us by submitting an issue to the related project. Even better, you can submit a Pull Request with a fix.

When reporting an issue, please use the template provided and fill everithing according to the trouble.
...
See the documentation of the project for more info about the installation or implementation of the project.


### Testing
See the documentation of the project for more info about testing.


### Style Guidelines
See the documentation of the project for more info about style guidelines.

### Code Formatting
See the documentation of the project for more info about formatting.
...
## Community
Enter to Discussions and enjoy our community.

[0]: https://docs.github.com/en/github/site-policy/github-community-guidelines
